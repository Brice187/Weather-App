...
function getWeatherForLocation(position) {
    ...
    var json = "http://api.openweathermap.org/data/2.5/weather?lat=" + lat + "&lon=" + lon + "&units=metric&appid=5ea8cbbb99b8ef0874beab4865254419";

    $.getJSON(json, function (a) {

        document.getElementById("data").innerHTML = "Temperatur: "+ a.main.temp + " celsius degree<br>Condition: "+ a.weather[0].main + "<br>Description: " + a.weather[0].description + "<br>City: " + a.name;
